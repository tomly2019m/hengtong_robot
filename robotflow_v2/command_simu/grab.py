...
if __name__ == '__main__':
    ...
    for input_param in params['Inputs']:
        ...
        elif input_param['Name'] == 'WorkpieceCurrentPosition':
            workpiece_current_position = input_param['Value']
    ...
    if arm_id == '105':
        # 如果是移动机械臂
        workpiece_current_position = 'arm1-' + workpiece_current_position
    elif arm_id == '106':
        # 如果是固定机械臂
        workpiece_current_position = 'arm2-' + workpiece_current_position
...
# #     # 测试用
    time.sleep(1)
    print(arm_id)
    print(workpiece_current_position)
